...
## 3) Цель Проекта:
    Итоговая цель это собрать адаптивную группу моделей которые понимают состояние рынка, адаптируются к нему и все время выдает прогнозы направления с высокой точностью и самокорекций с целью поддержания качества прогнозов (точности и количества совпадений с фактом)